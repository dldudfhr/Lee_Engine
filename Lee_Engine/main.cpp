...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, //프로그램의 인스턴스 핸들
                     _In_opt_ HINSTANCE hPrevInstance, //바로앞에 실행된 현재 프로그햄의 인스턴스 핸들, 없을경우에 NULL
                     ...
                     _In_ int       nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LEEENGINE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_LEEENGINE);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   p.Initialize(hWnd, width, height); //받은 핸들을 Application 함수에 넣음 my
